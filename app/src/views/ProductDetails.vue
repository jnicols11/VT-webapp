<template>
    ...
    <div v-if="hasError" class="text-center mt-10">
        ...
        <p class="mt-2 text-gray-500">We couldn't find the product you're looking for. Please try again later.</p>
    </div>

    <div v-if="!isLoading && !hasError && product" class="md:flex md:space-x-8">
        <div class="md:w-1/2">
            <img :src="product?.imageUrl" alt="Product Image" class="w-full h-auto object-cover rounded-lg" />
        </div>
        ...
        <div class="md:w-1/2 mt-6 md:mt-0">
            ...
            <div class="mt-6">
                ...
                <select v-model="selectedSize" id="size" class="mt-1 block w-1/2 rounded-md border-gray-300 shadow-sm">
